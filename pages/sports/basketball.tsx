...
<div className="mx-4 mt-4 mb-6 p-4 rounded-lg bg-[#0a1024] shadow text-center">
  ...
  <p className="text-sm mt-2 max-w-xl mx-auto">
    Basketball Competitions From Around The World — NBA, EuroLeague, NCAA, FIBA & More
  </p>
  <div className="flex justify-center items-center gap-4 mt-4">
    <Image src="/logos/usa.png" alt="NBA Logo" width={60} height={40} className="rounded shadow-md" unoptimized />
    <Image src="/logos/europe.png" alt="Euroleague Logo" width={60} height={40} className="rounded shadow-md" unoptimized />
  </div>
</div>
