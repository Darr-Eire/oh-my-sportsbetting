...
const popularAccumulators = [
  {
    name: "Premier League Triple",
    legs: ["Man City Win", "Liverpool Win", "Chelsea Win"],
    odds: "5.50",
  },
  {
    name: "Champions League Double",
    legs: ["Real Madrid Win", "Bayern Munich Win"],
    odds: "3.75",
  },
  {
    name: "La Liga Treble",
    legs: ["Barcelona Win", "Atletico Madrid Win", "Sevilla Win"],
    odds: "6.20",
  },
  {
    name: "Bundesliga Double",
    legs: ["Bayern Win", "Dortmund Win"],
    odds: "3.10",
  },
  {
    name: "MLS Mix",
    legs: ["LA Galaxy Win", "NYC Win"],
    odds: "4.00",
  },
];
      ...
      <div className="flex flex-col min-h-screen bg-[#0a1024] text-white font-sans">
        ...
        <main className="flex-1 px-4 py-6 pb-28 flex flex-col items-center text-center">
          ...
          <section className="mt-12 w-full max-w-3xl border border-white rounded-lg">
            ...
            {openBasketball && (
              <div id="basketball-matches" className="mt-4 space-y-6 px-4 pb-4 border-t border-white rounded-b-lg">
          ...
          {/* Today's Football Matches with dropdown leagues */}
              ...
              {todayMatches.map(({ league, countryCode, leagueLogo, matches }) => (
                <div key={league} className="border border-gray-700 rounded-lg bg-[#0a1024]">
                  <button
                    ...
                    className="flex items-center gap-3 w-full px-4 py-3 text-left text-white font-semibold hover:bg-[#14215c] transition"
          ...
          {/* Bet Builder Highlights Carousel */}
          <section className="mt-12 w-full max-w-3xl">
            <Slider {...betBuilderSettings}>
              <BetBuilderCarousel />
            </Slider>
          </section>

          {/* Popular Accumulators Carousel */}
          <section className="mt-10 w-full max-w-3xl">
            <h2 className="text-lg font-bold text-white mb-6">Popular Accumulators</h2>
            <Slider {...accumulatorSettings}>
              {popularAccumulators.map(({ name, legs, odds }, idx) => (
                <div
                  key={idx}
                  className="mx-2 bg-[#0a1024] border border-white rounded-lg p-4 hover:shadow-neon transition-shadow"
                >
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-white font-semibold">{name}</h3>
                    <span className="text-electricCyan font-bold">{odds}x</span>
                  </div>
          ...
          <section className="mt-12 w-full max-w-3xl border border-white rounded-lg">
            <button
              ...
              className="flex items-center gap-2 w-full px-4 py-3 text-left text-white font-semibold hover:bg-[#14215c] transition rounded-t-lg"
            ...
            {openHorseRacing && (
              <div id="horse-racing-races" className="mt-4 space-y-6 px-4 pb-4 border-t border-white rounded-b-lg">
                {[{
                  track: "Cheltenham",
                  countryCode: "gb",
                  raceTime: "14:30",
